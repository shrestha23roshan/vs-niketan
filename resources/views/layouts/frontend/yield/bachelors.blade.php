@section('dynamic-bachelors-data')
    <!--Banner-->
    @if (count($bachelorBanners) > 0)
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <?php $count = 1; ?>
                @if( count($bachelorBanners) > 0)
                    @foreach($bachelorBanners as $banner)
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <p class="text-red">{!! $bachelorMessages->designation !!} Message</p>
                        <h1 class="poppin-bold text-black text-uppercase">{!! $bachelorMessages->heading !!}</h1>
                        <p>{!! $bachelorMessages->description !!}</p>
                        <p class="poppin-semibold">{!! $bachelorMessages->name !!}</p>
                        <p>- {!! $bachelorMessages->designation !!}</p>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-4">
                        @if(file_exists('uploads/content-management/message/'.$bachelorMessages->attachment) && $bachelorMessages->attachment != '')
                            <img class="w-100 d-block box-shadow border-round"  src="{{ asset('uploads/content-management/message/'.$bachelorMessages->attachment) }}" alt="{{ $bachelorMessages->heading }}" width="200">
                        @else
                            <img class="w-100 d-block box-shadow border-round"  src="{{ asset('uploads/noimage.jpg') }}" alt="{{ $bachelorMessages->heading }}" width="200">
                        @endif
                    </div>
                </div>
            </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                <!--Upcoming Events-->
                <div class="col-sm-12 col-md-12 col-lg-8 mb-4" data-aos="fade-right"
                    ...
                    <div class="bg-white p-4 box-shadow border-round h-100">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                <div class="calender">
                                    <div id="bachelors-calendar"></div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                @if (count($bachelorEvents) > 0)
                                    @foreach ($bachelorEvents as $event)
                                        <div class="row mb-4">
                                            <div class="col-3">
                                            ...
                                            <div class="col-9">
                                                <h4><a class="poppin-medium text-black" href="{{ route('event.show', ['category' => 'bachelors', 'slug' => $event->slug]) }}">{{ str_limit(strip_tags($event->heading), 60) }}</a></h4>
                                            </div>
                                            <div class="col-12">
                ...
                @if (count($bachelorNotices) > 0)
                    <div class="col-sm-12 col-md-12 col-lg-4 mb-4" data-aos="fade-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="3000">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 px-0">
                        <div class="about-us-content">
                            <div class="img-gradient">
                                @if(file_exists('uploads/content-management/about-us/'.$bachelorAboutUs->attachment) && $bachelorAboutUs->attachment != '')
                                    <img class="w-100 h-100 d-block"  src="{{ asset('uploads/content-management/about-us/'.$bachelorAboutUs->attachment) }}" alt="about-us-img">
                                @else
                            ...
                            <div class="about-desc py-5">
                                <div class="container">
                                    <div class="row justify-content-start">
                                        <div class="col-sm-12 col-md-6 col-lg-6" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="3000">
                                            <h2 class="poppin-bold text-white text-uppercase">EXPLORE THE <br>
                                                VS NIKETAN SCHOOL</h2>
                                            <p class="text-white py-4">{{ str_limit(strip_tags($bachelorAboutUs->description),300)}}</p>
                                            <a href="{{ route('about-us.index', ['category' => 'bachelors']) }}">
        ...
        <section>
            <div class="container py-5">
                <div class="row">
                    ...
                    @foreach ($bachelorNews as $news)
                        <div class="col-sm-12 col-md-6 col-lg-4 mb-4"  data-aos-easing="ease-out-cubic" data-aos-duration="3000">
            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    @foreach ($facilities as $facility)
                        <div class="col-sm-12 col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="3000">
    ...
    @if ($achievements)
        <section class="bg-achievements">
            <div class="container py-5">
                ...
                <div class="row py-4 text-center" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="3000">
    ...
    <!--Testimonial-->
    @if (count($bachelorTestimonials) > 0)
        <section class="bg-white">
                ...
                <div class="row py-5">
                    ...
                    <div class="col-12">
                        <div class="regular slider">
                            @foreach ($bachelorTestimonials as $testimonial)
    ...
    <section class="bg-gray py-5">
        <div class="container">
            <div class="row">
                <!--Admission-->
                <div class="col-sm-12 col-md-6 col-lg-6 mb-4" data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="3000">

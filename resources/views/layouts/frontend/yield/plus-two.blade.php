@section('dynamic-plus-two-data')
    <!--Banner-->
    @if (count($plusTwoBanners) > 0)
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <?php $count = 1; ?>
                @if( count($plusTwoBanners) > 0)
                    @foreach($plusTwoBanners as $banner)
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <p class="text-red">{!! $plusTwoMessages->designation !!} Message</p>
                        <h1 class="poppin-bold text-black text-uppercase">{!! $plusTwoMessages->heading !!}</h1>
                        <p>{!! $plusTwoMessages->description !!}</p>
                        <p class="poppin-semibold">{!! $plusTwoMessages->name !!}</p>
                        <p>- {!! $plusTwoMessages->designation !!}</p>
                    </div>

                    <div class="col-sm-12 col-md-12 col-lg-4">
                        @if(file_exists('uploads/content-management/message/'.$plusTwoMessages->attachment) && $plusTwoMessages->attachment != '')
                            <img class="w-100 d-block box-shadow border-round"  src="{{ asset('uploads/content-management/message/'.$plusTwoMessages->attachment) }}" alt="{{ $plusTwoMessages->heading }}" width="200">
                        @else
                            <img class="w-100 d-block box-shadow border-round"  src="{{ asset('uploads/noimage.jpg') }}" alt="{{ $plusTwoMessages->heading }}" width="200">
                        @endif
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-white p-4 box-shadow border-round h-100">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                <div class="calender">
                                    <div id="plus-two-calendar"></div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                @if (count($plusTwoEvents) > 0)
                                    @foreach ($plusTwoEvents as $event)
                                        <div class="row mb-4">
                                            <div class="col-3">
                        ...
                        <div class="about-us-content">
                            <div class="img-gradient">
                                @if(file_exists('uploads/content-management/about-us/'.$plusTwoAboutUs->attachment) && $plusTwoAboutUs->attachment != '')
                                    <img class="w-100 h-100 d-block"  src="{{ asset('uploads/content-management/about-us/'.$plusTwoAboutUs->attachment) }}" alt="about-us-img">
                                @else
                                ...
                                <div class="container">
                                    <div class="row justify-content-start">
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            ...
                                            <p class="text-white py-4">{{ str_limit(strip_tags($plusTwoAboutUs->description),300)}}</p>
                                            <a href="{{ route('about-us.index', ['category' => 'plus-two']) }}">
        ...
        <section>
            <div class="container py-5">
                <div class="row">
                    ...
                    @foreach ($plusTwoNews as $news)
                        <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                            <div class="news-box bg-white border-round box-shadow">
                                <a href="{{ route('news.show', ['category' => 'plus-two', 'slug' => $news->slug]) }}">
                                ...
                                <div class="p-3">
                                    <a class="poppin-semibold text-black" href="{{ route('news.show', ['category' => 'plus-two', 'slug' => $news->slug]) }}">
                                    ...
                                    <a class="poppin-semibold" href="{{ route('news.show', ['category' => 'plus-two', 'slug' => $news->slug]) }}">READ MORE ></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    <!--Testimonial-->
    @if (count($plusTwoTestimonials) > 0)
        <section class="bg-white">
                ...
                <div class="row py-5">
                    ...
                    <div class="col-12">
                        <div class="regular slider">
                            @foreach ($plusTwoTestimonials as $testimonial)

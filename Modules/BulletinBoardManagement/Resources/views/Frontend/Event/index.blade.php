    ...
    @section('dynamic-school-data')
            ...
            <div class="container">
                <div class="row py-7">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <h1 class="poppin-bold text-white">EVENTS</h1>
        ...
        <section>
            <div class="container border-round box-shadow bg-white my-4 p-4">
                <div class="row">
                    <div class="col-12">
                        <h2 class="poppin-bold mb-4">UP COMMING EVENTS</h2>
                    </div>
                </div>
                <div class="row">
                    ...
                    @if (count($events) > 0)
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-9 col-md-9 col-lg-10">
                                        <h4><a class="poppin-medium text-black" href="{{ route('event.show', ['category' => 'school', 'slug' => $event->slug]) }}">{!! $event->heading !!}</a></h4>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="col-12">
                            <div class="pagination-box my-4">
                                @include('layouts.pagination.default', ['paginator' => $events])
                            </div>
                        </div>
                    @else
                        <div class="col-12">
                        ...
                        @foreach ($events as $event)
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-9 col-md-9 col-lg-10">
                                        <h4><a class="poppin-medium text-black" href="{{ route('event.show', ['category' => 'plus-two', 'slug' => $event->slug]) }}">{!! $event->heading !!}</a></h4>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        @foreach ($events as $event)
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-9 col-md-9 col-lg-10">
                                        <h4><a class="poppin-medium text-black" href="{{ route('event.show', ['category' => 'bachelors', 'slug' => $event->slug]) }}">{!! $event->heading !!}</a></h4>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        @foreach ($events as $event)
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-9 col-md-9 col-lg-10">
                                        <h4><a class="poppin-medium text-black" href="{{ route('event.show', ['category' => 'masters', 'slug' => $event->slug]) }}">{!! $event->heading !!}</a></h4>
                                    </div>
                                </div>
                            </div>
                        @endforeach

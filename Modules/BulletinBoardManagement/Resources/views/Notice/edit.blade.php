...
<script type="text/javascript">
    $(document).ready(function () {
        $('#noticeEditForm').formValidation({
            ...
            $('#noticeEditForm').formValidation('revalidateField', 'subject');
            $('#noticeEditForm').formValidation('revalidateField', 'description');
        })
                ...
                .each(function () {
                    $(this)
                        ...
                        .on('change', function (e) {
                            $('#noticeEditForm').formValidation('revalidateField', e.sender.name);
                        });
                });
    });
</script>
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="noticeEditForm" method="POST" action="{{ route('admin.bulletin-board-management.notice.update', $notice->id) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">

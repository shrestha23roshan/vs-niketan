...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#resultAddForm').formValidation({
            ...
            $('#resultAddForm').formValidation('revalidateField', 'download_caption');
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="resultAddForm" method="POST" action="{{ route('admin.download.result.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">

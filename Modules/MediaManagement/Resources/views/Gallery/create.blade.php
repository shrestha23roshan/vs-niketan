...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#galleryAddForm').formValidation({
            ...
            $('#galleryAddForm').formValidation('revalidateField', 'name');
        })
    });
</script>
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="galleryAddForm" method="POST" action="{{ route('admin.media-management.gallery.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new thumbnail" style="width: 600px; height: auto;">
                        <img src="{{ asset('uploads/media-management/gallery/default-img.jpg') }}" alt="">
                    </div>

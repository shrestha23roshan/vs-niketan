            ...
            <div class="container">
                <div class="row py-7">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <h1 class="poppin-bold text-white">Video Gallery</h1>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    @if (count($videos) > 0 )
                        ...
                        <div class="col-12">
                            <div class="pagination-box my-4">
                                @include('layouts.pagination.default', ['paginator' => $videos])
                            </div>
                        </div>

                    @else
                        <div class="col-12">
                            <h2 class="poppin-bold">No videos availabe</h2>
                        </div>
                    @endif
                        ...
                        @foreach ($videos as $video)
                            <div class="col-sm-12 col-md-6 col-lg-4 mb-5">
                                <div class="bg-white border-round p-3">
                                    ...
                                    <h4 class="text-center mt-2 poppin-semibold text-uppercase"><a href="{{ route('video.show', ['category' => 'masters', 'slug' => $video->slug]) }}">{{ $video->heading }}</a></h4>
                                </div>
                            </div>
                        @endforeach

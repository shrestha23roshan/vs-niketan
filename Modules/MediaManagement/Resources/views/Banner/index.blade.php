        ...
        <div class="box-body">
            ...
            <div class="tab-content ">
                ...
                <div class="tab-pane fade in active mt" id="school">
                    <table id="banner-table1" role="tabpanel" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>SN</th>
                                <th>Title</th>
                        ...
                        <tbody id="tablebody">
                            @foreach ($highSchoolBanners as $record)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $record->title}}</td>
                                    <td class="image">
                                        @if($record->attachment)
                                            <img src="{{ asset('uploads/media-management/banners/' . $record->attachment) }}" alt="{{ $record->name }}" width="200">
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.media-management.banner.edit', $record->id) }}" title="Edit banner"><button class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></button></a>&nbsp;
                ...
                <div class="tab-pane fade mt" id="plus_two">
                    <table id="banner-table4"  class="table table-bordered table-striped ">
                        <thead>
                        <tr>
                            <th>SN</th>
                            <th>Title</th>
                        ...
                        <tbody id="tablebody3">
                            @foreach ($plusTwoBanners as $record)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $record->title}}</td>
                                    <td class="image">
                ...
                <div class="tab-pane fade mt" id="bachelors">
                    <table id="banner-table2" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th>SN</th>
                            <th>Title</th>
                        ...
                        <tbody id="tablebody1">
                            @foreach ($bachelorsBanners as $record)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $record->title}}</td>
                                    <td class="image">
                ...
                <div class="tab-pane fade mt" id="masters">
                    <table id="banner-table3"  class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th>SN</th>
                            <th>Title</th>
                        ...
                        <tbody id="tablebody2">
                            @foreach ($mastersBanners as $record)
                                <tr>
                                    <td>{{ $loop->iteration}}</td>
                                    <td>{{ $record->title}}</td>
                                    <td class="image">
...
<script>
    $(document).ready(function() {
        var oTable = $('#banner-table1').dataTable();

        var oTable1 = $('#banner-table2').dataTable();

        var oTable2 = $('#banner-table3').dataTable();

        var oTable3 = $('#banner-table4').dataTable();
        ...
        /**----------- for tablebody1 --------------*/
        $('#tablebody1').on('click', '.delete-banner', function(e){
            e.preventDefault();
            $object = $(this);
            var id = $object.attr('id');
            swal({
        ...
        /**----------- for tablebody2 --------------*/
        $('#tablebody2').on('click', '.delete-banner', function(e){
            e.preventDefault();
            $object = $(this);
            var id = $object.attr('id');
            swal({
        ...
        /**------------ for tablebody3 -------------*/
        $('#tablebody3').on('click', '.delete-banner', function(e){
            e.preventDefault();
            $object = $(this);
            var id = $object.attr('id');
            swal({
